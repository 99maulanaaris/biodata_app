                        ...
                        <table class="table table-striped mb-3">
                            ...
                            <tbody id="clone-training">
                                ...
                                @else
                                    <tr>
                                        <td>
                                            <input type="text" value="" class="form-control" id="name_course" name="name_course[]">
                                        </td>
                                        <td>
                                            <input type="text" value="" class="form-control" id="sertification" name="sertification[]" placeholder="ada / tidak">
                                        </td>
                                        <td>
                                            <input type="text" value="" class="form-control" id="last_year_course" name="last_year_course[]">
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                            ...
                            <tbody id="clone-work">
                                ...
                                @else
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" value="" class="form-control" id="last_position" name="last_position[]">
                                        </td>
                                        <td>
                                            <input type="text" value="" class="form-control" id="last_income" name="last_income[]" data-type='currency'>
                                        </td>
                                        </td>
                                        <td>
                                            <input type="text" value="" class="form-control" id="last_year_work" name="last_year_work[]">
                                        </td>
                                    </tr>
                                @endif
